...
public class Ticket implements Comparable<Ticket> {
    ...
    public int compareTo(Ticket o) {
        if ("pension".equals(this.type) ^ "pension".equals(o.type)) {
            if ("pension".equals(this.type)) {
                return 1;
            } else return -1;
        }
    ...
    public Ticket withRegisterTime(OffsetDateTime registerTime) {
